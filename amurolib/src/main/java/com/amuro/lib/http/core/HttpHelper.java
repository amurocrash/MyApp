...
import com.amuro.lib.http.core.HttpRequest.OnHttpResponseListener;
...
import com.amuro.lib.http.response_parser.JsonParser;
...
public class HttpHelper<T>
{
    ...
    private OnHttpResponseListener getOnHttpResponseListener(final URLData urlData, final OnResponseListener<T> listener)
    {
        if(listener == null)
        {
            return null;
        ...
        OnHttpResponseListener httpListener = new OnHttpResponseListener()
        {
            @Override
